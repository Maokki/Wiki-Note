    ...
    <div class="container">
      ...
      <header class="category-header">
        <div class="header-top">
          ...
          <div class="header-actions">
            ...
            <button @click="toggleFlashcards" class="btn btn-maomao">
      ...
      <main class="items-section">
        ...
        <div v-if="flashcardMode && shuffledFlashcards.length > 0" class="flashcards">
          <div class="flashcard-container">
            <div class="flashcard-counter">
              {{ activeFlashcardIndex + 1 }} / {{ shuffledFlashcards.length }}
            </div>
            <div class="flashcard-card" @click="showAnswer = !showAnswer">
              <div class="flashcard-side">
                ...
                <h3 class="flashcard-content">
                  {{ showAnswer ? shuffledFlashcards[activeFlashcardIndex].description : shuffledFlashcards[activeFlashcardIndex].name }}
                </h3>
          ...
          <div class="flashcard-controls">
            <button @click="prevCard" class="btn btn-outline flashcard-btn">
              ← Previous
            </button>
            <button @click="showAnswer = !showAnswer" class="btn btn-primary flashcard-btn">
              {{ showAnswer ? 'Show Question' : 'Show Answer' }}
            </button>
            <button @click="nextCard" class="btn btn-outline flashcard-btn">
              Next →
            </button>
          </div>
        </div>

        <div v-else-if="flashcardMode && shuffledFlashcards.length === 0" class="no-flashcards">
          <div class="no-flashcards-icon">🧠</div>
          <h3 class="no-flashcards-title">No flashcards available</h3>
          <p class="no-flashcards-description">
            Add descriptions to your items to create flashcards for studying!
          </p>
          <button @click="toggleFlashcards" class="btn btn-primary">
            Back to Items
          </button>
        </div>
        ...
        <div v-else-if="filteredItems.length === 0 && currentCategory.items.length === 0" class="empty-state">
          ...
          <p class="empty-description">Add your first study item and begin your knowledge journey like Maomao!</p>
          <button @click="showAddItem = true" class="btn btn-primary">
            <Plus :size="20" />
            Add First Item
          </button>
        ...
        <div v-else-if="filteredItems.length === 0" class="no-results">
          ...
          <h3 class="no-results-title">No matching items</h3>
          <p class="no-results-description">Try adjusting your search or tag filters</p>
        </div>
        ...
        <div v-else class="items-grid">
          ...
          >
            ...
            <div v-if="item.description" class="item-preview">
